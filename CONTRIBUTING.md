...
issue](https://github.com/cisagov/ansible-role-valkey-cli/issues) in
...
request](https://github.com/cisagov/ansible-role-valkey-cli/pulls), you
...
```console
cd ansible-role-valkey-cli
pyenv virtualenv <python_version_to_use> ansible-role-valkey-cli
pyenv local ansible-role-valkey-cli
